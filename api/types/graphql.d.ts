...
type AllMappedModels = MaybeOrArrayOfMaybe<Photo>
...
export type ResolversTypes = {
  ...
  Photo: ResolverTypeWrapper<MergePrismaWithSdlTypes<PrismaPhoto, MakeRelationsOptional<Photo, AllMappedModels>, AllMappedModels>>;
...
export type ResolversParentTypes = {
  ...
  Mutation: {};
  Photo: MergePrismaWithSdlTypes<PrismaPhoto, MakeRelationsOptional<Photo, AllMappedModels>, AllMappedModels>;
  Query: {};
  Redwood: Redwood;
...
export type MutationResolvers<ContextType = RedwoodGraphQLContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  createPhoto: Resolver<ResolversTypes['Photo'], ParentType, ContextType, RequireFields<MutationcreatePhotoArgs, 'input'>>;
  deletePhoto: Resolver<ResolversTypes['Photo'], ParentType, ContextType, RequireFields<MutationdeletePhotoArgs, 'id'>>;
  updatePhoto: Resolver<ResolversTypes['Photo'], ParentType, ContextType, RequireFields<MutationupdatePhotoArgs, 'id' | 'input'>>;
};
...
export type MutationRelationResolvers<ContextType = RedwoodGraphQLContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  createPhoto?: RequiredResolverFn<ResolversTypes['Photo'], ParentType, ContextType, RequireFields<MutationcreatePhotoArgs, 'input'>>;
  deletePhoto?: RequiredResolverFn<ResolversTypes['Photo'], ParentType, ContextType, RequireFields<MutationdeletePhotoArgs, 'id'>>;
  updatePhoto?: RequiredResolverFn<ResolversTypes['Photo'], ParentType, ContextType, RequireFields<MutationupdatePhotoArgs, 'id' | 'input'>>;
};

export type PhotoResolvers<ContextType = RedwoodGraphQLContext, ParentType extends ResolversParentTypes['Photo'] = ResolversParentTypes['Photo']> = {
  id: OptArgsResolverFn<ResolversTypes['Int'], ParentType, ContextType>;
  photo: OptArgsResolverFn<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type PhotoRelationResolvers<ContextType = RedwoodGraphQLContext, ParentType extends ResolversParentTypes['Photo'] = ResolversParentTypes['Photo']> = {
  id?: RequiredResolverFn<ResolversTypes['Int'], ParentType, ContextType>;
  photo?: RequiredResolverFn<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};
...
export type QueryResolvers<ContextType = RedwoodGraphQLContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  photos: OptArgsResolverFn<Array<ResolversTypes['Photo']>, ParentType, ContextType>;
...
export type QueryRelationResolvers<ContextType = RedwoodGraphQLContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  photo?: RequiredResolverFn<Maybe<ResolversTypes['Photo']>, ParentType, ContextType, RequireFields<QueryphotoArgs, 'id'>>;
  photos?: RequiredResolverFn<Array<ResolversTypes['Photo']>, ParentType, ContextType>;
